...
QA run modes include `dry-run`, `mock`, `playwright`, and `playwright-mcp`; legacy modes such as `deterministic`, `ai_exploratory`, `regression`, and `smoke` remain accepted for compatibility.
