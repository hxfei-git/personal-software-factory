...
- Retained operational docs now describe current queue, API, auth, schema, storage, artifact, safety, and integration behavior without old phase-entry wording. Remaining phase/batch wording in retained operational docs was normalized to current-runtime and future-approved-task wording.
